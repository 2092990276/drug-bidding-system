...
<head>
    ...
    <style>
        ...
        input[type="text"], input[type="number"], input[type="date"], input[type="double"], textarea, select {
            width: 100%;
            padding: 8px;
...
<body>
    ...
    <div class="content">
        <div class="tender-form">
            <h2>添加招标信息</h2>
            <form action="doAddTender" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea id="packagingRequirements" name="packagingRequirements" required></textarea>
                </div>
                <div class="form-group">
